 ...
 * 
 * ~~~js
 * import { AutoComplete } from 'pq-component-library'
 * ~~~
 */
export const AutoComplete: React.FC<AutoCompleteProps> = (props) => {
  ...
  useClickOutside(componentRef as RefObject<HTMLElement | null>, () => {
    setSuggestions([])
  ...
  const generateDropdown = () => {
    return (
      ...
      >
        <ul className="pq-suggestion-list">
          {loading && (
  ...
  return (
    <div className="pq-auto-complete" ref={componentRef}>
      <Input
        {...restProps}
        value={inputValue}
