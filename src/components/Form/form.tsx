...
import useStore, { type FormState } from './useStore'

/** 与 async-validator 校验错误结构兼容，避免强依赖其类型声明 */
...
export const Form = forwardRef<IFormRef, FormProps>((props, ref) => {
  const { name = 'pq_form', children, initialValues, onFinish, onFinishFailed } = props
  ...
  return (
    <form name={name} className="pq-form" onSubmit={submitForm}>
