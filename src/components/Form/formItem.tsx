...
export const FormItem: FC<FormItemProps> = (props) => {
  ...
  const rowClass = classNames('pq-row', {
    'pq-row-no-label': !label
  })
  useEffect(() => {
  ...
  const labelClass = classNames({
    'pq-form-item-required': isRequired
  })
  const itemClass = classNames('pq-form-item-control', {
    'pq-form-item-has-error': hasError
  })
  ...
  return (
    <div className={rowClass}>
      { label &&
        <div className="pq-form-item-label">
          <label title={label} className={labelClass}>
            {label}
          </label>
        </div>
      }
      <div className="pq-form-item">
        <div className={itemClass}>
          {returnChildNode}
        </div>
        { hasError && 
          <div className="pq-form-item-explain">
